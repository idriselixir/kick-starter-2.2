...
const items = [
  ...
  const PlayNow = () => {
    ...
    return (
      <div className="flex flex-col items-center text-center justify-center pt-[40px] gap-[20px]">
        ...
        <div className="flex justify-center items-center gap-4 relative w-[80%]">
          ...
          >
            ...
            {items.map((item) => (
              ...
              <div key={item.id}>
                <div className="flex ml-[150px]  border-[6px] border-slate-400 gap-6 w-40 h-40 md:w-60 md:h-60  bg-green-500 lg:w-[300px] lg:h-[250px] xl:w-[400px] xl:h-[350px] transition-transform duration-300 transform hover:scale-110 hover:border-hidden group">
